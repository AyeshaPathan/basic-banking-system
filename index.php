...
<body>
  ...
  <section class="topContent">
    ...
    <<div class="topContentImg">
      <img src="images/blue.jpg" alt="Banking">
    </div>
  </section>
  <!-- End Home -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 mx-auto">
          <img class=" mt-3 " style="width:530px;" height="500px" text-align="centre" ; src="images/capture.png" alt="TSF Bank">
        </div>
    ...
    <div class="container  text-center">
      <div class="row">
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          <img src="images/cust.jpg" class="card-img-top mt-3 img" alt="Responsive image">
          <div class="card-body">
        ...
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          <img src="images/mony.png" class="card-img-top mt-3 img" alt="Responsive image">
          <div class="card-body">
  ...
  <br>
    ...
    <form>
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Leave your comments here...."></textarea>
      </div>
